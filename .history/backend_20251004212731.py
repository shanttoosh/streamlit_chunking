...
# -----------------------------
# 🔹 Enhanced Preprocessing Pipeline Functions
# -----------------------------
...
def preprocess_csv_enhanced(input_obj, fill_null_strategy=None, type_conversions=None, 
                           drop_duplicates_cols=None, remove_stopwords_flag=False,
                           normalization_method="none"):
    """
    Enhanced CSV preprocessing pipeline
    """
    # Load CSV
    ...
    # Step 1: Validate and normalize headers
    df.columns = validate_and_normalize_headers(df.columns)
    
    # Step 2: Replace common null representations
    ...
    if normalization_method in ["lemmatize", "stem"]:
        df, _ = apply_text_normalization(df, normalization_method)
