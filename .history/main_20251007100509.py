...
async def deep_config_chunk(
    ...
    try:
        ...
        if chunk_method == "fixed":
            ...
            chunks = chunk_semantic_cluster_enhanced(current_df)
        ...
        # Store in global state
        global current_chunks, current_metadata
...
async def deep_config_embed(
    ...
    try:
        ...
        # Store in global state
        global current_model, current_embeddings
        current_model = model
...
async def deep_config_store(
    ...
    try:
        ...
        return {
            ...
            "vectors_stored": len(current_chunks)
        }
...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=8000)        ye