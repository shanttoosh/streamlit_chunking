...
<style>
    ...
    :root {
        ...
        --text-secondary: var(--ev-colors-secondaryText);
        --text-primary: var(--ev-colors-text);
        --background: var(--ev-colors-background);
        --brand-yellow: var(--ev-colors-highlight);
        --orange: var(--ev-colors-highlight);
        --card-outline: var(--ev-colors-borderColor);
        --section-outline-bottom: var(--ev-colors-secondary);
        --card-background: var(--ev-colors-primary);
        --text-disabled: var(--ev-colors-tertiaryText);
        --badge-outline: var(--ev-colors-borderColor);
        --button-press-outline: var(--ev-colors-secondary);
        --button-press-bg: var(--ev-colors-tertiary);
        --article-text-color: var(--ev-colors-text);
        --red: var(--ev-colors-danger);
        --green: var(--ev-colors-success);
        --brand-orange: var(--ev-colors-highlight);
        --hero-subtitle-text: var(--ev-colors-text);
    }
    ...
    .main-header {
        ...
        margin-bottom: 2rem;
        text-align: center;
        box-shadow: 0 8px 32px rgba(231, 95, 51, 0.3);
    ...
    .mode-card {
        ...
        border: 2px solid var(--ev-colors-borderColor);
        border-radius: 15px;
        padding: 1.5rem;
    ...
    .mode-card:hover {
        ...
        box-shadow: 0 12px 24px rgba(231, 95, 51, 0.2);
    }
    
    .mode-card.selected {
        border-color: var(--ev-colors-highlight);
        background: rgba(231, 95, 51, 0.1);
        box-shadow: 0 8px 16px rgba(231, 95, 51, 0.3);
    }
    ...
    .mode-description {
        color: var(--ev-colors-secondaryText) !important;
    ...
    .source-option:hover {
        ...
        box-shadow: 0 6px 16px rgba(231, 95, 51, 0.2);
    }
    ...
    .stButton > button {
        ...
        box-shadow: 0 4px 12px rgba(231, 95, 51, 0.3) !important;
    }
    
    .stButton > button:hover {
        background: var(--ev-colors-secondary) !important;
        transform: translateY(-2px) !important;
        box-shadow: 0 6px 16px rgba(231, 95, 51, 0.4) !important;
    }
    ...
    .stSuccess {
        background-color: rgba(216, 252, 119, 0.1) !important;
    ...
    .stWarning {
        background-color: rgba(231, 95, 51, 0.1) !important;
...
if st.session_state.selected_mode:
    ...
    with col2:
        ...
        if st.button("Choose Database", key="source_db", use_container_width=True):
...
if st.session_state.selected_mode and st.session_state.data_source == "csv" and hasattr(st.session_state, 'uploaded_file') and st.session_state.uploaded_file is not None:
    ...
    if st.session_state.selected_mode == "fast":
        ...
        st.markdown("### Config-1 Mode Configuration")
        ...
        st.markdown("### Deep ModeConfiguration")
