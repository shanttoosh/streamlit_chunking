...
def call_deep_config_chunk_api(chunk_method: str, chunk_size: int, overlap: int, key_column: str = None, token_limit: int = 2000):
    """Step 6: Chunk data"""
    try:
        data = {
...
def call_deep_config_embed_api(model_name: str, use_openai: bool, openai_api_key: str = None, openai_base_url: str = None, batch_size: int = 64):
...
def call_deep_config_store_api(storage_type: str, collection_name: str):
