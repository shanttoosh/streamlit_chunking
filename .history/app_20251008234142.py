...
<style>
    ...
    /* Remove default Streamlit theme colors */
    .stApp {
        background: var(--ev-colors-background) !important;
    ...
    /* Sidebar styling - uniform and aligned */
    .css-1d391kg {
        background: var(--ev-colors-primary) !important;
    ...
    .card-content {
        color: var(--ev-colors-tertiaryText) !important;
        font-size: 0.95em !important;
        line-height: 1.5 !important;
    }
    
    /* Buttons - uniform styling, no hover changes */
    .stButton > button {
        background: var(--ev-colors-secondary) !important;
        color: var(--ev-colors-text) !important;
        border: 1px solid var(--ev-colors-borderColor) !important;
    ...
    .mode-button > button {
        background: var(--ev-colors-primary) !important;
        color: var(--ev-colors-text) !important;
        border: 2px solid var(--ev-colors-highlight) !important;
        border-radius: 8px !important;
    ...
    .process-step.running {
        border-left-color: var(--ev-colors-highlight) !important;
        background: var(--ev-colors-secondary) !important;
    }
    
    .process-step.completed {
        border-left-color: var(--ev-colors-success) !important;
        background: var(--ev-colors-secondary) !important;
    }
    
    .process-step.pending {
        border-left-color: var(--ev-colors-secondary) !important;
    }
    ...
    .stFileUploader > div > div {
        background: var(--ev-colors-primary) !important;
        border: 2px dashed var(--ev-colors-borderColor) !important;
        border-radius: 8px !important;
        padding: 20px !important;
    }
    
    /* Messages - uniform styling */
    .stSuccess {
        background: var(--ev-colors-primary) !important;
        color: var(--ev-colors-success) !important;
        border: 1px solid var(--ev-colors-success) !important;
    ...
    .stError {
        ...
        border: 1px solid var(--ev-colors-danger) !important;
    ...
    .stWarning {
        ...
        border: 1px solid var(--ev-colors-highlight) !important;
        border-left: 4px solid var(--ev-colors-highlight) !important;
        border-radius: 4px !important;
        padding: 12px 15px !important;
    }
    ...
    *:hover {
    ...
    /* Override any remaining Streamlit default colors */
    .stMarkdown {
        color: var(--ev-colors-text) !important;
    }
    ...
    /* Remove any blue/green highlights */
...
with st.sidebar:
    st.markdown("""
    <div style="background: var(--ev-colors-highlight); padding: 20px; border-radius: 8px; margin-bottom: 20px; text-align: center;">
        <h2 style="color: white; margin: 0; font-size: 1.3em; font-weight: 600;">Process Tracker</h2>
    </div>
    """, unsafe_allow_html=True)
...
with col1:
    if st.button("⚡ Fast Mode", use_container_width=True, key="fast_mode_btn"):
        st.session_state.current_mode = "fast"
        st.session_state.process_status = {k: "pending" for k in st.session_state.process_status}
with col2:
    if st.button("⚙️ Config-1 Mode", use_container_width=True, key="config1_mode_btn"):
        st.session_state.current_mode = "config1"
        st.session_state.process_status = {k: "pending" for k in st.session_state.process_status}
with col3:
    if st.button("🔬 Deep Config Mode", use_container_width=True, key="deep_mode_btn"):
...
st.markdown("---")
st.markdown("""
<div style="text-align: center; color: var(--ev-colors-tertiaryText); font-size: 0.9em; background: var(--ev-colors-primary); padding: 20px; border-radius: 8px; margin-top: 30px;">
