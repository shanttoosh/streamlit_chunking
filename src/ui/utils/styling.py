...
def render_status_indicator(status: str, text: str = None) -> str:
    """Render status indicator"""
    return create_status_badge(status, text)

def render_metric_card(label: str, value: str, delta: str = None) -> str:
    """Render metric card"""
    return create_metric_card(label, value, delta)

def render_info_card(title: str, content: str, icon: str = "ℹ️") -> str:
    """Render info card"""
    return create_info_card(title, content, icon)